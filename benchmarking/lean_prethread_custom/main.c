...
{
    while (1) // we put a while true here and below so that there is constant communication between the two
              // remove and instert operations. mutex isn't needed because it all happens inside prethreading
    {
